export default {
  ...
  setting: {
    title: '设置',
    openPerformance: '性能模式(Beta)',
    enableFreeDrag: '开启节点自由拖拽',
    isEnableNodeRichText: '开启节点富文本编辑',
  ...
  edit: {
    ...
    newFeatureNoticeMessage:
      '本次更新支持了节点富文本编辑，但是存在一定缺陷，最主要的影响是导出为图片的时间和节点数量成正比，所以对导出需求比较依赖的话可以通过【基础样式】-【其他配置】-【开启节点富文本编辑】设置关掉富文本编辑模式。',
    root: '根节点',
    ...
    painterTip: '点击画布空白处结束操作',
    createAssociativeLineTip: '点击画布空白处取消操作',
    savingTip: '正在保存中，请稍后再试',
    savingTip2: '思维导图为空，或正在渲染中，请稍后再试',
    savingTip3: '保存成功',
    savingTip4: '保存失败',
  ...
  guide: {
    btn: '关闭引导',
    tip1: '要更新![[]]嵌入到其他文档中的预览图像需要手动点击保存',
    tip2: '激活节点后，可在这里修改节点内容（图片、图标...）',
    tip3: '这里可以修改节点样式、切换主题/结构等等',
    tip4: '这里可以查看快捷键信息',
    tip5: '这里有一些辅助功能（小地图、演示模式...）'
  },
  previewMode: {
    emptyTitle: '未解析到可渲染数据',
    emptyDesc: '目前仅能解析部分 markdown 语法，比如标题、列表',
    close: '关闭'
  }
}
