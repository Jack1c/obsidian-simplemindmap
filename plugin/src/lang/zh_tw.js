export default {
  ...
  edit: {
    ...
    painterTip: '點擊畫布空白處取消或結束',
    createAssociativeLineTip: '點擊畫布空白處取消',
    savingTip: '正在保存中，請稍後再試',
    savingTip2: '心智圖為空，或正在渲染中，請稍後再試',
    savingTip3: '保存成功',
    savingTip4: '保存失敗',
  ...
  fileSelectList: {
    searchPlaceholder: '蒐索檔名'
  },
  guide: {
    btn: '關閉導航',
    tip1: '在其他文件中嵌入![[]]圖片時，需要手動點擊保存',
    tip2: '在啟用節點後，可以在這裡修改節點內容（圖片、圖標...）',
    tip3: '這裡可以修改節點樣式、切換主題/結構等等',
    tip4: '這裡可以查看快捷鍵信息',
    tip5: '這裡有一些輔助功能（小圖映射、演示模式...）'
  },
  previewMode: {
    emptyTitle: '未解析到可渲染數據',
    emptyDesc: '現時僅能解析部分markdown語法，比如標題、清單',
    close: '關閉'
  }
}
